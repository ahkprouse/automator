; If you're just learning AutoHotkey,Take a look at our AutoHotkey Udemy courses!
; You can always get a coupon code here:https://the-Automator.com/Learn
...
{ ; AUTOEXECglo
	...
	Gui, Add, Edit, x61 y30 w355 h20 vURLL HWNDh2, ;URL
	...
	Gui, Add, Edit, x235 y55 w180 h20 vEleIDs HWNDh5, ID ;Element IDs
	
	
	Gui,Add,Text,x1,Class:
	Gui,Add,Edit,x+M yp-2 w300 HWNDClassEdit vClassEdit1
	...
	Gui, Add, ListView, x6 y112 w410 h100 -LV0x10 AltSubmit vVarListView gSubListView NoSortHdr, % "Frame.#|name|id"
	gui, font, s12 c0
	
	YPos:=212
	Gui, Add, GroupBox,% "x6 y" YPos " w410 h100 vText", InnerText
	Gui, Add, Edit,% "x10 y" (YPos+=22) " w402 h70 vhtml_text HWNDh6", ;Inner text
	
	Gui, Add, GroupBox,% "x6 y" (YPos+=80) " w410 h230", OuterHTML
	Gui, Add, Edit,% "x10 y" (YPos+=22) " w402 h200 vhtml_value HWNDh7", ;OuterHTML window
	...
	Gui, Show, % "x" A_ScreenWidth-530 " y" 0 " w" 422, % Stored.AppName ;Main gui
	Gui, +LastFoundExist
...
{ ; Update the Main GUI with the New Element Info
	...
	GuiControl,,%ClassEdit%,% OuterHH.GetAttribute("Class")
