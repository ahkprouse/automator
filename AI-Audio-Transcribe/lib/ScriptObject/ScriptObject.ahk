...
class ScriptObj {
	...
	*/
	...
	static GetLicense()
	{
		...
		license := Gui('', 'License')
		license.SetFont('s12')
		license.AddText('w260', 'Paste the License Code here:')
		LiEdit := license.AddEdit('w260 vLicenseNumber section Password')
		Chk    := license.AddCheckbox('xs','Show Password')
		Chk.OnEvent('click',(*)=>showpassword(Chk, LiEdit))
		license.AddButton('xm+100 w75 vTest', 'Save').OnEvent('Click', Save)
