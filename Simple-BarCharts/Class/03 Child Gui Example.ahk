...
{
	myChart := BarChart(chartName) ; creating chart object
	myChart.Guioptions := '-caption  Parent' mGui.Hwnd ; using Gui options to make chart child of main Gui
	barGui := myChart.Create(Chartmap,'hide x10 y80') ; creating chart with data and hiding it
