...
;Source : https://github.com/TheArkive/scintilla_ahk2 
class Scintilla extends Gui.Custom {
    ...
    */
    ...
    /**
     * @param {Array} p 
     * @returns {Void} - Or specify the return type if applicable.
     */
    setKeywords(p*) {
        Loop 8 {
    ...
    makeWordLists() {
     ...
     /**
     * @param {Object} scn - An object with properties used for DLL call preparation.
     */
    ...
    /**
     * @param {Object} scn ;- An object, likely containing data relevant to chunk coloring.
     * @param {Object} data ;- An object with a `ptr` property used for the DLL call.
     * @param {Object} wordList ;- An object with a `ptr` property used for the DLL call.
     * @returns {Integer} ;- The result from the DLL call.
     */
    ...
    /**
     * @param {Object} scn - An object, likely containing data relevant to the deletion routine.
     * @param {Object} data - An object with a `ptr` property used for the DLL call.
     * @returns {Integer} - The result from the DLL call.
     */
    ...
    /**
     * @param {Integer} pos
     * @returns {Object} - An object with `x` and `y` properties representing the coordinates of the specified position.
     */
    ...
    /**
     * @param {Integer} token
     * @param {Integer} flags - Optional; 1 for COALESCE, 0 for NONE.
     */
    ...
    class Brace extends Scintilla.scint_base {
        ...
        BadColor {
         ...
         /**
         * @param {Integer} in_pos - Optional; default is -1.
         */
    ...
    class Caret extends Scintilla.scint_base {
        ...
        Fore {                                              ; color
         ...
         /**
         * @param {Integer} line - The line number to go to.
         */
        GoToLine(line) {
        ...
        PolicyY(policy:=0, pixels:=0) {             ; 1 = SLOP, 4 = STRICT, 8 = EVEN, 16 = JUMPS
         ...
         /**
         * @param {Integer} pos - The position to set the caret to.
         */
    ...
    class Edge extends Scintilla.scint_base {
        ...
        /**
         * @param {Integer} column - The column number for the edge.
         * @param {Integer} color - The color of the edge.
         * @returns {Void}
         */
        Add(column, color) {
    ...
    class LineEnding extends Scintilla.scint_base {
         /**
         * @param {Integer} mode - The line ending mode; 0 for CRLF, 1 for CR, 2 for LF.
         */
    ...
    class Marker extends Scintilla.scint_base {
        ...
        /**
         * @param {Integer} line
         * @param {Integer | String} markerNum 
         */
        ...
        /**
         * @param {Integer} line - The line number to delete the marker from.
         * @param {String} markerNum - Optional; the marker number to delete, or an empty string to use the default.
         */
        Delete(line, markerNum:="") {
            return this._sms(0x7FC, line, (markerNum!="")?markerNum:this.num)   ; SCI_MARKERDELETE
        }
        /**
         * @param {String} markerNum - Optional; the marker number to delete, or an empty string to delete all markers.
         */
        DeleteAll(markerNum:="") {
            return this._sms(0x7FD, (markerNum!="")?markerNum:this.num) ; SCI_MARKERDELETEALL
        }
         /**
         * @param {Integer} hMarker - The handle of the marker to delete.
         */
