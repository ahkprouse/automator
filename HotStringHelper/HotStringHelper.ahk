...
;*******************************************************
#h::  ; Win+H hotkey  https://www.autohotkey.com/docs/Hotstrings.htm#Helper
; Get the text currently selected. The clipboard is used instead of "ControlGet Selected" because it works in a greater variety of editors
; (namely word processors).  Save the current clipboard contents to be restored later. Although this handles only plain text, it seems better than nothing:
