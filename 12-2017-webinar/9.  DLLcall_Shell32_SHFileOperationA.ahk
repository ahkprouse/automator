...
Browser_Back::
;**************************************
Folder:="B:\the-automator\Webinar\Scripts\2017-12-Files and Folders\Files_to_manipulate\"

fSource:=Folder . "Making Decisions.mp4"
fTarget:="b:\" . "Making Decisions.mp4"
;~CopyMoveFiles(fSource,fTarget,"move") 
